...
//   const handleFormDetailGeometry = useCallback((index) => {
//     setFormData((prev) => ({
//       ...prev,
...
//             };
//           } catch (error) {
//             console.warn("Không thể format geometry: ", error);
//           }
//         }
//         return detail;
//       }),
...
//   const validateDetailGeometry = useCallback(() => {
//     if (!value || value.trim() === "") {
...
//       if (!validTypes.includes(parsed.validTypes)) {
//         setGeometryError((prev) => ({
//           ...prev,
//           [index]: `Type ${
//             parsed.type
...
//         return false;
//       }
//       setGeometryError((prev) => ({ ...prev, [index]: "" }));
//       return true;
//     } catch (error) {
//       setGeometryError((prev) => ({
//         ...prev,
//         [index]: "Lỗi cú pháp JSON. Kiểm tra dáu ngoặc và dấu phẩy.",
//       }));
//     }
//   }, []);

//   const handleGeometryChangeWithValidation = useCallback((index, value) => {
...
//   const handleClearDetailGeometry = useCallback((index) => {
...
//                         <button
//                           type="button"
//                           onClick={() => handleFormDetailGeometry(index)}
//                           style={{
//                             position: "absolute",
//                             top: "12px",
//                             right: "8px",
